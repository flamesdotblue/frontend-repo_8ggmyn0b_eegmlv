...
export default function App() {
  ...
  const [persona, setPersona] = useState('Chitti');
    ...
    <div className="min-h-screen w-full bg-white text-zinc-900">
      ...
      <header className="sticky top-0 z-10 w-full border-b border-zinc-200 bg-white/80 backdrop-blur">
        <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-base md:text-lg font-semibold">{persona} — Virtual Human Friend</h1>
          </div>
      ...
      <main className="mx-auto max-w-7xl px-4 pt-4 pb-10">
        <div className="grid lg:grid-cols-2 gap-6 items-stretch">
          {/* 3D background with avatar overlay */}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm">
              <p className="text-sm text-zinc-600">Speak naturally. Responses are shown as text and voiced with tone and expressions synced to the avatar.</p>
            </div>
          </div>
        </div>
      </main>
